...
import 'package:tdvpnext/components/backend/products/create_products.dart';
...
import 'package:tdvpnext/utility/config_text_button.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const CreateProductPages(),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    /*
                                  Text(
                                    "แบบ ${productModels[index].category}",
                                    softWrap: true,
                                    maxLines: 1,
                                  ...
                                  */
                                    ConfigText(
                                      lable:
                                          "รหัส ${productModels[index].code.toString()}",
                                      textStyle: StyleProjects().contentstyle5,
                                    ),
                                    Text(
